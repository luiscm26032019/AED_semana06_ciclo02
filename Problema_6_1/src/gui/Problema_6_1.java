...
public class Problema_6_1 extends JFrame implements ActionListener {
	...
	void limpieza() {
		txtEdad.setText("");
		txtEdad.requestFocus();  //Para que el usuario comience a escribir o editar datos de inmediato sin necesidad de hacer clic en el componente con el ratón.
	}
	void listar() {
		txtS.setText("");
	...
	int leerEdad()  {
		return Integer.parseInt(txtEdad.getText().trim()); //trim es para eliminar espacios en blanco al inicio o al final de una cadena
	}
